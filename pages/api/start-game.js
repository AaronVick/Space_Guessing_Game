import { fetchCharacterData, fetchRandomCharacterNames } from './spaceService';
...
export default async function handler(req, res) {
  ...
  try {
    ...
    // Fetch the character data or space object data
    let characterData, wrongCharacterName;
    try {
      characterData = await fetchCharacterData();  // or fetch relevant space data
